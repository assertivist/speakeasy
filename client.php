		...
		<div class="login_overlay" id="modal">
			<div class="login_box" id="modalbox">
				...
				<div class="login_pane" id="no_server">
					The server for this game room is not started.<br/>Please <a href="javascript:location.reload(true);" style="color:inherit;">refresh</a> to check again, or <a href="javascript:history.back();" style="color:inherit;">go back</a>.
				</div>
			</div>
		</div>
		<div class="container">
